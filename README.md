...
| 구분 | 내용 |
|------|------|
| **프로젝트 구분** | 금융·은행권 웹 서비스 개발 |
| **프로젝트 명** | 금융권 예금상품 통합 관리 시스템 - 부제: 딸깍은행 WEB 개발 |
| **배경 및 목적** | <ul><li>금융권의 예금 및 금융상품 정보를 통합 관리할 수 있는 웹·앱 서비스 구현</li><li>실제 은행 서비스 구조를 반영하여 금융 데이터 설계, 관리, 보안 흐름을 경험</li><li>기획부터 UI*UX, 프론트에서 백엔드까지 전 과정을 이해하고 협업 역량을 강화</li></ul> |
...
| **작업 기간** | <ul><li>2025.11.06 (목) ~ 2025.12.07 (일) / 160h</li></ul> |
| **작품 발표일** | <ul><li>2025.12.08 (월) 14:00</li></ul> |
...
| 날짜 | 내용 |
|------|------|
| <ul><li>개발: 2025.11.06 (목) ~ 2025.12.07 (일) / 160h</li></ul> | <ul><li>발표: 2025.12.08 (월) 14:00</li></ul> |
